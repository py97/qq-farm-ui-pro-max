...
echo "=========================================================="
echo "  QQ 农场助手 - x86 服务器 一键极速全栈部署体系"
...
if [ "$ARCH" != "x86_64" ]; then
    ...
    print_info "如果是 ARM64 架构（树莓派/Mac），请使用 deploy-arm.sh 脚本"
    exit 1
fi
print_success "服务器架构匹配：$ARCH (x86_64) - 获取本地源级支持"
